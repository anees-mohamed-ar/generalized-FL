...
class CustomModel:
    ...
    def score(self, X_test, y_test):
        ...
        # Use a threshold to convert continuous predictions to binary (0 or 1)
...
if __name__ == "__main__":
    try:
        ...
        fl_model = FederatedLearning(num_rounds=10, learning_rate=0.15, model_path="global_model.pkl")
