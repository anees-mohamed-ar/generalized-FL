"""
a small bug in fl-v13--8
it is not saving the json file untill the surpass loop ends
so added this
"""
...
class FederatedNode(threading.Thread):
    ...
    def run(self):
        ...
        self.gradients = model.feature_importances_
...
if __name__ == "__main__":
    try:
        ...
        fl_model = FederatedLearning(num_rounds=50, learning_rate=0.5, model_path="global_model.json")
