...
class FederatedNode(threading.Thread):
    ...
    def run(self):
        ...
        local_weights = model.feature_importances_
...
class FederatedLearning:
    ...
    def initialize_global_model(self, n_features):
        return np.random.randn(n_features) * 0.01  # Random initialization for stability
    ...
    def update_global_model(self, global_weights, aggregated_weights):
        ...
        global_weights = decrypted_weights  # Update global weights
        return global_weights
